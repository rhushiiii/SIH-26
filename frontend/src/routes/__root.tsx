  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "DRISHTI GeoAI converts drone orthophotos into structured GIS intelligence — buildings, roads, and waterbodies with confidence and human review.",
      },
